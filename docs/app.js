...
var _user$project$Weather$weather = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'description',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Weather$Weather))));
var _user$project$Weather$Data = F3(
	function (a, b, c) {
		return {time: a, temp: b, weather: c};
	});
var _user$project$Weather$data = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	A2(
		_elm_lang$core$Json_Decode$map,
		_elm_lang$core$List$head,
		A2(
			_elm_lang$core$Json_Decode$field,
			'weather',
			_elm_lang$core$Json_Decode$list(_user$project$Weather$weather))),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'temp',
		_user$project$Weather$temp,
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
			A2(
				_elm_lang$core$Json_Decode$map,
...
var _user$project$View$weatherIcon = F2(
	function (size, id) {
		var _p0 = {
			ctor: '_Tuple3',
			_0: A2(_elm_lang$core$Basics_ops['%'], (id / 100) | 0, 10),
			_1: A2(_elm_lang$core$Basics_ops['%'], (id / 10) | 0, 10),
			_2: A2(_elm_lang$core$Basics_ops['%'], id, 10)
		};
		_v0_6:
		do {
			switch (_p0._0) {
					...
					return A2(
						...
						'flash_on',
						{
							...
							_0: _debois$elm_mdl$Material_Color$text(
								A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Yellow, _debois$elm_mdl$Material_Color$S500)),
							_1: {
								ctor: '::',
								_0: size,
								_1: {ctor: '[]'}
...
var _user$project$View$tempFormat = function (temp) {
	var intString = _elm_lang$core$Basics$toString(
		_elm_lang$core$Basics$floor(temp));
	var frac = temp - _elm_lang$core$Basics$toFloat(
		_elm_lang$core$Basics$floor(temp));
	var fracString = A3(
		_elm_lang$core$String$slice,
		1,
		3,
		_elm_lang$core$Basics$toString(frac));
	return A2(_elm_lang$core$Basics_ops['++'], intString, fracString);
};
var _user$project$View$weatherRow = function (data) {
	var icon = A2(
		_elm_lang$core$Maybe$withDefault,
		...
		A2(
			...
			function (_p1) {
				return A2(
					_user$project$View$weatherIcon,
	...
	var low = A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View$tempFormat(data.temp.min),
		'°');
	var high = A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$View$tempFormat(data.temp.max),
		'°');
	var day = A2(_mgold$elm_date_format$Date_Format$format, '%m / %d', data.time);
	return A2(
			...
			_1: {
				...
				_0: A2(
					_debois$elm_mdl$Material_Grid$cell,
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Grid$size, _debois$elm_mdl$Material_Grid$Tablet, 3),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Grid$size, _debois$elm_mdl$Material_Grid$Phone, 1),
								_1: {
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									high,
									A2(_elm_lang$core$Basics_ops['++'], ' / ', low))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$cardAction = F2(
	function (mdl, _p2) {
		var _p3 = _p2;
		var _p4 = _p3._0;
		return A2(
...
var _user$project$View$cardText = function (data) {
	var items = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$List$map(_user$project$View$weatherRow),
			_elm_lang$core$List$tail(data.list)));
	return A2(
		_debois$elm_mdl$Material_Card$text,
		{ctor: '[]'},
		items);
};
var _user$project$View$cardHeader = function (_p5) {
	var _p6 = _p5;
	var today = _elm_lang$core$List$head(_p6.list);
	var date = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(
	...
	var temp = A2(
		...
		A2(
			_elm_lang$core$Maybe$map,
			function (_p9) {
				return _user$project$View$tempFormat(
					function (_) {
						return _.day;
					}(
						function (_) {
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$div,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '2rem 2rem 0'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], temp, '°')),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$card = F2(
	function (mdl, _p10) {
		var _p11 = _p10;
		var _p12 = _p11._1;
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$View$cardHeader(_p12),
				_1: {
					ctor: '::',
					_0: _user$project$View$cardText(_p12),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$View$cardAction,
							mdl,
							{ctor: '_Tuple2', _0: _p11._0, _1: _p12}),
						_1: {ctor: '[]'}
					}
				}
			});
		...
		_0: A2(
			...
			},
			{
				...
				_0: A5(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Textfield$label('Input PlaceName'),
						_1: {
							ctor: '::',
						...
						model.mdl,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Model$AddCity),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '100%'),
											_1: {ctor: '[]'}
										...
										function (_p13) {
											return A2(
												...
												A3(
													...
													{ctor: '[]'},
													A2(_user$project$View$card, model.mdl, _p13)));
										},
										A2(
											_elm_lang$core$List$indexedMap,
											F2(
